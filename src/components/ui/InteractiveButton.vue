<template>
  <div class="relative">
    <div
      ...
      class="absolute inset-0 rounded-md transform translate-y-0.5"
...
const buttonVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 relative overflow-hidden transform transition-all duration-100 ease-in-out cursor-pointer',
  {
    variants: {
      variant: {
